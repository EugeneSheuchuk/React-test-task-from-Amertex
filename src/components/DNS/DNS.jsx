...
const DNS = (props) => {
    ...
    useEffect(
        () => props.saveDNSFieldValue(props.uniqueKey, 'AutoDNS', true),
        []
    );
    ...
    const onClickRadio = (bool) =>
        props.saveDNSFieldValue(uniqueKey, 'AutoDNS', bool);
    ...
    return (
        <React.Fragment>
            ...
            <Field
                type="text"
                fieldName={'Preferred DNS server:'}
                id={`P_DNS_server_${uniqueKey}`}
                value={pDNS}
                action={typeField}
                required={true}
                errorText={errorpDNS}
            ...
            <Field
                type="text"
                fieldName={'Alternative DNS server:'}
                id={`A_DNS_server_${uniqueKey}`}
                value={aDNS}
                action={typeField}
                required={false}
                errorText={erroraDNS}
